...
begin
	...
	@variable(P0, x_[1:nS, 1:nD] >= 0)
	@variable(P0, y_[1:nD, 1:nR] >= 0)
...
begin
	...
	# println(tikz_code)
	tikZnetwork_solution2 = TikzPicture("""$(tikz_code)""", options="scale=1.0", preamble="")
end
...
- The MDP materials are from [Stanford AA228 course materials by Mykel Kochenderfer](https://aa228.stanford.edu/). 
...
julia_version = "1.9.0"
manifest_format = "2.0"
project_hash = "d094cd690d78242b88f5c9b05431077834f2fcf2"
...
git-tree-sha1 = "a77cc33e3ec1704edc7ab8dca37ccff26d75766a"
